...
// GetSeratUseCaser is an autogenerated mock type for the GetSeratUseCaser type
type GetSeratUseCaser struct {
	mock.Mock
}

// Exec provides a mock function with given fields: ctx, id
func (_m *GetSeratUseCaser) Exec(ctx context.Context, id uuid.UUID) (*entity.Serat, error) {
