...
type mockConstructorTestingTNewSeratRepository interface {
	mock.TestingT
	Cleanup(func())
}

// NewSeratRepository creates a new instance of SeratRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSeratRepository(t mockConstructorTestingTNewSeratRepository) *SeratRepository {
	mock := &SeratRepository{}
	mock.Mock.Test(t)
