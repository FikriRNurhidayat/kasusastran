...
func (_m *LoginService) Call(_a0 context.Context, _a1 *svc.LoginParams) (*svc.LoginResult, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *svc.LoginResult
	if rf, ok := ret.Get(0).(func(context.Context, *svc.LoginParams) *svc.LoginResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*svc.LoginResult)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *svc.LoginParams) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
